...
fn create_compiler_snapshot(
  ...
  op_crate_libs.insert("deno.webtransport", deno_webtransport::get_declaration());
...
fn main() {
  ...
  println!(
    "cargo:rustc-env=DENO_WEBTRANSPORT_LIB_PATH={}",
    deno_webtransport::get_declaration().display()
  );
  println!(
